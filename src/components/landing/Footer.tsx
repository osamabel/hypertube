        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Pricing</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Documentation</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Releases</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Press</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Status</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition duration-300">Community</Link></li>
            </ul>
          </div>
        </div>
